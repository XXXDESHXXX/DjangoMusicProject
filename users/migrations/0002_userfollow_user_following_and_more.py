...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='following',
            field=models.ManyToManyField(through='users.UserFollow', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='userfollow',
            index=models.Index(fields=['-created'], name='users_userf_created_708d5b_idx'),
        ),
    ]
